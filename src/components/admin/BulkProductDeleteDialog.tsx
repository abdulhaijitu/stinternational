...
interface BulkProductDeleteDialogProps {
  open: boolean;
...
export function BulkProductDeleteDialog({
  open,
  onOpenChange,
  selectedCount,
  onConfirm,
      ...
      <AlertDialogContent className={cn(isBangla && "font-siliguri")}>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left">
            {translations.description.replace("{count}", String(selectedCount))}
          </AlertDialogDescription>
        </AlertDialogHeader>
