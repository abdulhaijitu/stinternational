...
export const bn = {
  ...
  about: {
    ...
    subtitle: "বাংলাদেশে বৈজ্ঞানিক, শিল্প এবং শিক্ষামূলক যন্ত্রপাতির জন্য আপনার বিশ্বস্ত অংশীদার। আমরা বিশ্বব্যাপী প্রযুক্তি ও স্থানীয় দক্ষতার সমন্বয়ে সারাদেশে প্রতিষ্ঠানগুলিকে সেবা প্রদান করি।",
    
    // Platform Section
    aboutPlatform: "প্ল্যাটফর্ম সম্পর্কে",
    platformDescription: "ST International একটি আধুনিক ডিজিটাল প্ল্যাটফর্মের মাধ্যমে বৈজ্ঞানিক ও শিল্প যন্ত্রপাতিতে ব্যাপক অ্যাক্সেস প্রদান করে। আমরা সরাসরি ক্রয়, সাবস্ক্রিপশন-ভিত্তিক সেবা এবং প্রাতিষ্ঠানিক ক্রেতাদের জন্য কাস্টম কোটেশন অফার করি।",
    
    // What We Offer
    whatWeOffer: "আমরা কী অফার করি",
    productTypes: [
      "ল্যাবরেটরি ও বৈজ্ঞানিক যন্ত্রপাতি",
      "পরিমাপ ও নির্ভুল যন্ত্রপাতি",
      "শিল্প ও প্রকৌশল সরঞ্জাম",
      "শিক্ষা উপকরণ ও ডকুমেন্টেশন",
    ],
    
    // How It Works
    howItWorks: "কীভাবে কাজ করে",
    step1Title: "ব্রাউজ করুন ও বাছাই করুন",
    step1Desc: "একাধিক ক্যাটাগরিতে ৫০০০+ পণ্যের ক্যাটালগ অন্বেষণ করুন। টাইপ, ব্র্যান্ড বা স্পেসিফিকেশন অনুযায়ী ফিল্টার করুন।",
    step2Title: "কোটেশন অনুরোধ বা ক্রয়",
    step2Desc: "সরাসরি ক্রয়ের জন্য কার্টে যোগ করুন, অথবা বাল্ক ও প্রাতিষ্ঠানিক অর্ডারের জন্য কাস্টম কোটেশন অনুরোধ করুন।",
    step3Title: "নিরাপদ পেমেন্ট",
    step3Desc: "ব্যাংক ট্রান্সফার, ক্যাশ অন ডেলিভারি বা প্রতিষ্ঠানের জন্য ক্রেডিট টার্মস সহ একাধিক পেমেন্ট অপশন থেকে বেছে নিন।",
    step4Title: "ডেলিভারি ও সাপোর্ট",
    step4Desc: "ইনস্টলেশন সাপোর্ট সহ সারাদেশে ডেলিভারি। সমস্ত পণ্য ওয়ারেন্টি ও বিক্রয়োত্তর সেবা সহ।",
    
    // Trust Section
    trustTitle: "বিশ্বাস ও স্বচ্ছতা",
    trustSubtitle: "আমরা প্রতিটি ইন্টারঅ্যাকশনে নিরাপত্তা, স্পষ্টতা এবং ব্যবহারকারীর অভিজ্ঞতাকে অগ্রাধিকার দিই",
    securePayments: "নিরাপদ পেমেন্ট",
    securePaymentsDesc: "সমস্ত লেনদেন শিল্প-মানের নিরাপত্তা দ্বারা সুরক্ষিত। আপনার সুবিধার জন্য একাধিক পেমেন্ট অপশন।",
    clearAccessRules: "স্পষ্ট অ্যাক্সেস নিয়ম",
    clearAccessRulesDesc: "স্বচ্ছ মূল্য, ওয়ারেন্টি শর্তাবলী এবং রিটার্ন পলিসি। কোনো লুকানো ফি বা চমক নেই।",
    userFocusedDesign: "ব্যবহারকারী-কেন্দ্রিক ডিজাইন",
    userFocusedDesignDesc: "সহজ নেভিগেশন, দ্রুত চেকআউট এবং আপনার প্রকিউরমেন্ট প্রক্রিয়াকে নির্বিঘ্ন করতে নিবেদিত সাপোর্ট।",
    ...
    readyToPartner: "শুরু করতে প্রস্তুত?",
